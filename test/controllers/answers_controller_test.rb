...
class AnswersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create answer" do
    assert_difference('Answer.count') do
      post answers_url, params: { answer: { document_id: @answer.document_id, reply: @answer.reply } }
    end
  ...
  test "should update answer" do
    patch answer_url(@answer), params: { answer: { document_id: @answer.document_id, reply: @answer.reply } }
